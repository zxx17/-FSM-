...
public class SnowFlakeFactory {
  ...
  public static SnowFlake getSnowFlake() {
    return new SnowFlake(SnowFlakeConstants.DEFAULT_DATACENTER_ID, SnowFlakeConstants.DEFAULT_MACHINE_ID);
  }
  ...
  public static SnowFlake getSnowFlakeFromCache() {
    ...
    if (snowFlake == null) {
      snowFlake = new SnowFlake(SnowFlakeConstants.DEFAULT_DATACENTER_ID, SnowFlakeConstants.DEFAULT_MACHINE_ID);
  ...
  public static SnowFlake getSnowFlakeByDataCenterIdAndMachineIdFromCache(Long dataCenterId, Long machineId) {
    ...
    String key = SnowFlakeConstants.DEFAULT_SNOW_FLAKE.concat("_").concat(String.valueOf(dataCenterId)).concat("_").concat(String.valueOf(machineId));
